...
//  Proyecto_INT
//
//  Created by David Alge Balaguer on 30/11/22.
//

import UIKit

class ZonaMovil: UITableViewController {
...
//asdasd
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "miCeldaMovil", for: indexPath) as! CeldaMovil
...
class CeldaMovil : UITableViewCell {
